...
#FRAMEWORK_PATH=`$SPACK_ROOT/bin/spack location -i ophidia-analytics-framework`
...
mpiexec.hydra -n ${ncores} -outfile-pattern ${log} -errfile-pattern ${log} ${HOME}/.ophidia/${serverid}${taskid}.submit.sh
